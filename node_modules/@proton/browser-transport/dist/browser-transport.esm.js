...
var styleSelector = function styleSelector(walletType) {
...
var BrowserTransport = /*#__PURE__*/function () {
  ...
  var _proto = BrowserTransport.prototype;
  ...
  _proto.setupElements = function setupElements(title) {
    var _this = this;
    ...
    if (this.injectStyles && !this.styleEl) {
      ...
      var css = styleSelector(this.walletType).replace(/%prefix%/g, this.classPrefix);
    ...
    if (!this.requestEl) {
      ...
      var nav = this.createEl({
        "class": 'nav'
      });
      var navHeader = this.createEl({
        "class": 'header',
        tag: 'span',
        text: ''
      });
  ...
  _proto.clearDuplicateContainers = function clearDuplicateContainers() {
    var elements = document.getElementsByClassName(this.classPrefix);
  ...
  _proto.displayRequest = /*#__PURE__*/function () {
    var _displayRequest = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(request) {
      var sameDeviceRequest, sameDeviceUri, crossDeviceUri, logoEl, qrEl, linkEl, linkA, iframe, backgroundEl, divider, actionEl, footnoteEl, isIdentity, footnoteLink;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 9;
              _context.next = 12;
              return toString(crossDeviceUri, {
                margin: 0,
                errorCorrectionLevel: 'L'
              });

            case 12:
              qrEl.innerHTML = _context.sent;
              _context.next = 18;
              break;
            ...
            case 15:
              ...
              console.warn('Unable to generate QR code', _context.t0);
            ...
            case 18:
              ...
              linkA = this.createEl({
                tag: 'a',
                href: crossDeviceUri,
                text: "Open " + this.walletType.replace(/\b[a-z]/g, function (letter) {
              ...
              backgroundEl = this.createEl({
                "class": 'background'
              });
              divider = this.createEl({
                "class": 'separator',
                text: 'OR'
              });
              ...
              if (isIdentity) {
                footnoteEl = this.createEl({
                  "class": 'footnote',
                  text: "Don't have " + this.walletType.replace(/\b[a-z]/g, function (letter) {
                    return letter.toUpperCase();
                  }) + " Wallet? "
                });
  ...
  _proto.showLoading = /*#__PURE__*/function () {
    var _showLoading = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
  ...
  _proto.onRequest = function onRequest(request, cancel) {
    this.activeRequest = request;
    this.activeCancel = cancel;
    this.displayRequest(request)["catch"](cancel);
  };

  _proto.onSessionRequest = function onSessionRequest(session, request, cancel) {
  ...
  _proto.onSuccess = function onSuccess(request) {
    var _this2 = this;
    ...
    if (request === this.activeRequest) {
      ...
      if (this.requestStatus) {
        ...
        var info = request.isIdentity() ? 'Your wallet was successfully linked' : 'Your transaction was successfully signed';
        var infoTitle = this.createEl({
          "class": 'title',
          tag: 'span',
          text: info
        ...
        this.requestEl.appendChild(infoEl);
        this.show();
        this.closeTimer = global.setTimeout(function () {
          _this2.hide();
        }, 1.5 * 1000);
      } else {
        this.hide();
  ...
  _proto.onFailure = function onFailure(request, error) {
...
//# sourceMappingURL=browser-transport.esm.js.map
