...
const colorConvert = __webpack_require__(2085);
...
const stdoutColor = __webpack_require__(2130).stdout;
...
module.exports = {
    ...
    'shiftjis': {
        type: '_dbcs',
        table: function() { return __webpack_require__(7051) },
        encodeAdd: {'\u00a5': 0x5C, '\u203E': 0x7E},
        encodeSkipVals: [{from: 0xED40, to: 0xF940}],
    },
    'csshiftjis': 'shiftjis',
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(2190) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(2190).concat(__webpack_require__(853)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'gb18030': {
        type: '_dbcs',
        table: function() { return __webpack_require__(2190).concat(__webpack_require__(853)) },
        gb18030: function() { return __webpack_require__(7251) },
        encodeSkipVals: [0x80],
        encodeAdd: {'€': 0xA2E3},
    },
    ...
    'cp949': {
        type: '_dbcs',
        table: function() { return __webpack_require__(6650) },
    },
    ...
    'cp950': {
        type: '_dbcs',
        table: function() { return __webpack_require__(7768) },
    },
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(7768).concat(__webpack_require__(8073)) },
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(6068); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(4823)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(6215)(iconv);
}
