...
export declare const deserializeActionData: (contract: Contract, account: string, name: string, data: string | Uint8Array | number[]) => any;
/** Deserialize action. If `data` is a `string`, then it's assumed to be in hex. */
export declare const deserializeAction: (contract: Contract, account: string, name: string, authorization: Authorization[], data: string | Uint8Array | number[]) => Action;
...
export declare const deserializeAnyObject: (buffer: SerialBuffer, state?: SerializerState | undefined) => {};
