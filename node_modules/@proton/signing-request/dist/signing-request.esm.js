...
var AbiTypes = /*#__PURE__*/Serialize.getTypesFromAbi( /*#__PURE__*/Serialize.createInitialTypes(), data);
/** Chain ID aliases. */
...
var SigningRequest = /*#__PURE__*/function () {
  ...
  _proto.getSignatureDigest = function getSignatureDigest() {
    var buffer = new Serialize.SerialBuffer(); // protocol version + utf8 "request"
  ...
  _proto.resolveActions = function resolveActions(abis, signer) {
    return this.getRawActions().map(function (rawAction) {
      ...
      var action = Serialize.deserializeAction(contract, rawAction.account, rawAction.name, rawAction.authorization, rawAction.data);
  ...
  _proto.resolve = function resolve(abis, signer, ctx) {
    ...
    var actions = transaction.actions.map(function (action) {
      ...
      var contract = getContract(contractAbi);
      return Serialize.serializeAction(contract, action.account, action.name, action.authorization, action.data);
    });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 13:
            ...
            return _context5.abrupt("return", Serialize.serializeAction(contract, action.account, action.name, action.authorization, action.data));
...
export { ChainName, PlaceholderAuth, PlaceholderName, PlaceholderPermission, ResolvedSigningRequest, SigningRequest, abi, idToName, nameToId };
//# sourceMappingURL=signing-request.esm.js.map
