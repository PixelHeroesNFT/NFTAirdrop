...
var RIPEMD160 = _interopDefault(require('ripemd-ts'));
...
var convertK1ToLegacyPublicKey = function convertK1ToLegacyPublicKey(publicKey, prefix) {
  ...
  var bytesWithChecksum = bs58.decode(nonPrefixPublicKey);
...
var privateKeyToLegacyString = function privateKeyToLegacyString(key) {
  if (key.type === KeyType.k1 && key.data.length === privateKeyDataSize) {
    ...
    var digest = new Uint8Array(hash.sha256().update(hash.sha256().update(whole).digest()).digest());
...
var generateKeyPair = function generateKeyPair(type, options) {
  ...
  var publicKey = PublicKey.fromElliptic(ellipticKeyPair, type, ec);
  var privateKey = PrivateKey.fromElliptic(ellipticKeyPair, type, ec);
  return {
    publicKey: publicKey,
...
var defaultEc = /*#__PURE__*/new elliptic.ec('secp256k1');
...
var Api = /*#__PURE__*/function () {
  ...
  _proto.deflateSerializedArray = function deflateSerializedArray(serializedArray) {
    return pako.deflate(serializedArray, {
      level: 9
    });
  }
  ...
  _proto.inflateSerializedArray = function inflateSerializedArray(compressedSerializedArray) {
    return pako.inflate(compressedSerializedArray);
  }
  /**
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            chain = _ref.chain;
            url = constants.constants.BLOKS_API + "/" + chain + "/kyc?type=countries&chain=" + chain;
            _context.next = 4;
            return this.get(url);
                            ...
                            return runtime_1.wrap(function _callee4$(_context4) {
                              while (1) {
                                switch (_context4.prev = _context4.next) {
                                  ...
                                  case 6:
                                    url = constants.constants.BLOKS_API + "/" + chain + "/kyc?type=status&chain=" + chain + "&actor=" + actor;
                                    _context4.next = 9;
  ...
  _applyForKyc = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7(params) {
    ...
    return runtime_1.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            url = constants.constants.BLOKS_API + "/" + params.chain + "/kyc";
            _context7.next = 3;
  ...
  _currentLocation = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee8() {
    ...
    return runtime_1.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            url = constants.constants.PROTON_API + "/v1/kyc/ip-info";
            _context8.next = 3;
            return this.get(url);
  ...
  _getTokenPrices = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = constants.constants.METAL_PROTON_ENDPOINT + "/v1/chain/exchange-rates/info";
            _context.prev = 1;
            _context.next = 4;
            return this.get(url);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            url = constants.constants.METAL_PROTON_ENDPOINT + "/v1/swaps/calculate-estimated-fee";
            _context2.prev = 2;
            _context2.next = 5;
  ...
  _otcQuote = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(body) {
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = constants.constants.SWAP_URL + ("/v1/quote/" + body.baseSymbol + "/" + body.baseAmount + "/" + body.quoteSymbol);
            _context.next = 3;
            return this.get(url);
  ...
  _otcOrder = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(id) {
    ...
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            url = constants.constants.SWAP_URL + ("/v1/order/" + id);
            _context2.next = 3;
            return this.get(url);
  ...
  _generateAddress = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(body) {
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = constants.constants.WRAP_SERVER_URL + '/address/generate';
            _context.next = 3;
  ...
  _withdrawMetal = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(body) {
    ...
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            url = constants.constants.WRAP_SERVER_URL + '/withdraw';
            _context2.next = 3;
            return this.post(url, body);
  ...
  _withdrawalHistoryMetal = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(account) {
    ...
    return runtime_1.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            url = constants.constants.WRAP_SERVER_URL + ("/withdrawals/" + account);
            _context3.next = 3;
            return this.get(url);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 24:
              ...
              if (!(secondsBehind > constants.constants.MAX_SECONDS_BEHIND && this.endpoints.length > 1)) {
                _context.next = 32;
                break;
              }
...
//# sourceMappingURL=js.cjs.development.js.map
