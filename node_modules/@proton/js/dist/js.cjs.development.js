...
var _fetch = _interopDefault(require('cross-fetch'));
        ...
        while (1) {
          switch (_context26.prev = _context26.next) {
            case 0:
              ...
              }, new elliptic.ec('p256')); // Recreate the data the browser actually signed
...
var JsonRpc = /*#__PURE__*/function () {
  ...
  /*#__PURE__*/
  function () {
    var _get_activated_protocol_features = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee8(_ref) {
      var _ref$limit, limit, _ref$search_by_block_, search_by_block_num, _ref$reverse, reverse, lower_bound, upper_bound;

      return runtime_1.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              _ref$limit = _ref.limit, limit = _ref$limit === void 0 ? 10 : _ref$limit, _ref$search_by_block_ = _ref.search_by_block_num, search_by_block_num = _ref$search_by_block_ === void 0 ? false : _ref$search_by_block_, _ref$reverse = _ref.reverse, reverse = _ref$reverse === void 0 ? false : _ref$reverse, lower_bound = _ref.lower_bound, upper_bound = _ref.upper_bound;
              _context8.next = 3;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 27:
              ...
              e = new elliptic.ec('p256'); // https://github.com/indutny/elliptic/pull/232
