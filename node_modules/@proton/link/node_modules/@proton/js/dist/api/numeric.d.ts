...
export declare const stringToPublicKey: (s: string, prefix?: string) => Key;
/** Convert public `key` to legacy string (base-58) form */
export declare const publicKeyToLegacyString: (key: Key, prefix?: string) => string;
/** Convert `key` to string (base-58) form */
export declare const publicKeyToString: (key: Key) => string;
/** If a key is in the legacy format (`EOS` prefix), then convert it to the new format (`PUB_K1_`).
 * Leaves other formats untouched
 */
export declare const convertLegacyPublicKey: (s: string, prefix?: string) => string;
export declare const convertK1ToLegacyPublicKey: (publicKey: string, prefix?: string) => string;
/** If a key is in the legacy format (`EOS` prefix), then convert it to the new format (`PUB_K1_`).
 * Leaves other formats untouched
 */
