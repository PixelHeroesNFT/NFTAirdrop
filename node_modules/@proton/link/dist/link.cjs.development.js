...
var esr = require('@proton/signing-request');
...
var types = /*#__PURE__*/js.Serialize.getTypesFromAbi( /*#__PURE__*/js.Serialize.createInitialTypes(), linkAbi);
/**
...
function normalizePublicKey(key) {
  ...
  return js.Numeric.publicKeyToString(js.Numeric.stringToPublicKey('EOS' + key.substr(-50)));
}
/**
...
var Link = /*#__PURE__*/function () {
  ...
  function Link(options) {
    ...
    if (options.rpc === undefined || typeof options.rpc === 'string') {
      this.rpc = new js.JsonRpc(options.rpc || defaults.rpc);
    } else {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return esr.SigningRequest.create(_extends({}, args, {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 8:
              ...
              signer = res.signer;
              signerKey = js.Key.Signature.fromString(res.signatures[0]).recover(message).toLegacyString();
              _context5.next = 13;
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              requestKey = js.Key.PrivateKey.fromString(privateKey).getPublicKey().toLegacyString();
              createInfo = {
...
//# sourceMappingURL=link.cjs.development.js.map
